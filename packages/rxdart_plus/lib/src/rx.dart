...
import 'package:rxdart_plus/src/utils/error_and_stacktrace.dart';
import 'package:rxdart_plus/streams.dart';

/// A utility class that provides static methods to create the various Streams
/// provided by RxDart Plus.
///
/// ### Example
///
///      Rx.combineLatest([
...
///
/// ### Learning RxDart Plus
///
/// This library contains documentation and examples for each method. In
/// addition, more complex examples can be found in the
/// [RxDart Plus github repo](https://github.com/ReactiveX/rxdart) demonstrating how
/// to use RxDart Plus with web, command line, and Flutter applications.
///
/// #### Additional Resources
///
/// In addition to the RxDart Plus documentation and examples, you can find many
/// more articles on Dart Streams that teach the fundamentals upon which
/// RxDart Plus is built.
///
...
///
///    - RxDart Plus works with any API that expects a Dart Stream as an input.
