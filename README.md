...
<p align="center">
<img src="https://github.com/ReactiveX/rxdart/blob/master/assets/logo.png?raw=true" height="200" alt="RxDart Plus" />
</p>
...
| Package                     | Pub                                                                                         |
|-----------------------------|---------------------------------------------------------------------------------------------|
| [`rxdart_plus`](packages/rxdart_plus) | [![Pub](https://img.shields.io/pub/v/rxdart_plus.svg)](https://pub.dartlang.org/packages/rxdart_plus) |
